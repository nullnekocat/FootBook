<nav class="navbar navbar-expand-md navbar-dark bg-dark">
    <div class="container">      
        <a class="bbh-sans-bartle navbar-brand" href="index.php">FootBook</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <!-- Wiki -->
                <li class="nav-item">
                    <a class="nav-link" href="router.php?page=wiki">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="router.php?page=login">Login</a>
                        <a class="dropdown-item" href="router.php?page=signup">Sign up</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="router.php?page=profile">Profile</a>
                    </div>
                </li>
                <!-- Language -->
                <li class="nav-item dropdown">
               ...
               <li class="nav-item dropdown">
                ...
                <!-- Admin -->
                <li class="nav-item">
                    <a class="nav-link" href="router.php?page=admin">
